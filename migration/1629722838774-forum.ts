...
export class forum1629722838774 implements MigrationInterface {
    name = 'forum1629722838774'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`rapaxia\`.\`forum_topic\` (\`id\` int NOT NULL AUTO_INCREMENT, \`updated\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`created\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`title\` varchar(255) NOT NULL, \`description\` varchar(255) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`rapaxia\`.\`forum_thread\` (\`id\` int NOT NULL AUTO_INCREMENT, \`updated\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`created\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`title\` varchar(255) NOT NULL, \`body\` varchar(255) NOT NULL, \`topicId\` int NULL, \`authorId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`rapaxia\`.\`forum_reply\` (\`id\` int NOT NULL AUTO_INCREMENT, \`updated\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`created\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`body\` varchar(255) NOT NULL, \`threadId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TABLE \`rapaxia\`.\`forum_reply\``);
        await queryRunner.query(`DROP TABLE \`rapaxia\`.\`forum_thread\``);
        await queryRunner.query(`DROP TABLE \`rapaxia\`.\`forum_topic\``);
    }
